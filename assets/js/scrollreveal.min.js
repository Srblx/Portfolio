...
//     }
//     function h(e) {
//       for (let t = [], n = arguments.length - 1; 0 < n--; ) t[n] = arguments[n + 1];
...
//           let t = parseInt(e.getAttribute("data-sr-id"));
//           i.active.push(t);
//         });
//       } catch (e) {
//         throw e;
...
//           let t = n.store.containers[e].node;
...
//     }
//     function z() {
//       for (let e = [], t = 0; t < 16; t++) t % 5 == 0 ? e.push(1) : e.push(0);
//       return e;
//     }
//     function F(e, t) {
//       for (let n = N(e), i = N(t), r = [], o = 0; o < 4; o++)
...
//     })();
//     function p(e) {
//       let t = window.getComputedStyle(e.node),
//         n = t.position,
//         i = e.config,
//         r = {},
...
//       try {
//         f(u(e), function (e) {
//           let t = e.getAttribute("data-sr-id");
//           if (null !== t) {
//             i = !0;
//             let n = r.store.elements[t];
...
//     }
//     function v(n) {
//       for (let e = [], t = arguments.length - 1; 0 < t--; ) e[t] = arguments[t + 1];
//       if (s(n))
//         return (
//           f(e, function (e) {
//             f(e, function (e, t) {
...
//       t.call(this),
//         f(this.store.elements, function (e) {
//           let t = [e.styles.inline.generated];
//           e.visible
...
//         }),
//         f(this.store.containers, function (e) {
//           let t = e.node === document.documentElement ? window : e.node;
...
//     function c(e, t) {
//       void 0 === t && (t = {});
//       let n = t.pristine || this.pristine,
//         i =
...
//       let n = this.store.sequences[e.sequence.id],
//         i = e.sequence.index;
//       if (n) {
//         let r = new d(n, "visible", this.store),
//           o = new d(n, "revealed", this.store);
//         if (((n.models = { visible: r, revealed: o }), !o.body.length)) {
//           let s = n.members[r.body[0]],
...
//     function R(e, t) {
//       for (
//         let n = t ? e.node.clientHeight : e.node.offsetHeight,
...
//         x(function () {
//           let n = "init" === e.type || "resize" === e.type;
...
//                   void 0 === e && (e = {});
//                   let t = this.store.containers[e.containerId];
//                   if (t) {
//                     let n = Math.max(0, Math.min(1, e.config.viewFactor)),
